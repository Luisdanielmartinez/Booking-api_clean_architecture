...
namespace Tarker.Booking.Api.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdatePassword([FromBody] UpdateUserPasswordModel model, [FromServices]
        IUpdateUserPasswordCommand updateUserPasswordCommand, [FromServices] IValidator<UpdateUserPasswordModel>validator)
        {
            var validate = await validator.ValidateAsync(model);
        ...
        [HttpGet("get-by-usernama-password/{userName}/{password}")]
        public async Task<IActionResult> GetByUserNameAndPassowrd(string userName, string password,
            [FromServices] IGetUserByUserNameAndPasswordQuery getUserByUserNameAndPasswordQuery, [FromServices] IValidator<(string, string)> validator)
        {
