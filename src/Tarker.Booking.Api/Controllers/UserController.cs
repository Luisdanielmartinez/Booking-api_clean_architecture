...
namespace Tarker.Booking.Api.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetByUserNameAndPassowrd(string userName,string passowrd, 
            [FromServices] IGetUserByUserNameAndPasswordQuery getUserByUserNameAndPasswordQuery)
        {
            var data = await getUserByUserNameAndPasswordQuery.Execute(userName,passowrd);
